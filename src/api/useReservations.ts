...
const useReservations = () => {
  ...
  const getReservations = async (): Promise<Reservation[]> => {
    try {
    const reservations: Reservation[] = await fetch(API_URL).then(res => res.json())
    return reservations
    } catch(err) {
  ...
  const addNewReservation = async (reservation: Reservation): Promise<Reservation> => {
    try {
  ...
  const deleteReservation = async (reservation: Reservation): Promise<Reservation> => {
    try {
